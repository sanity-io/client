...
describe('client', async () => {
  ...
  describe('DATA', () => {
    ...
    test.skipIf(isEdge)('delete() returns all document ids when not returning first', async () => {
    ...
    test.skipIf(isEdge)('mutate() returns all documents when not returning first', async () => {
      const docs = [
