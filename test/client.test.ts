...
describe('client', async () => {
  ...
  describe('DATA', () => {
    ...
    // Variant definition actions target `system.variant` documents rather than
    // content documents, so they are exercised in their own request — though the
    // API does accept them in the same batch as document actions.
    ...
    test.skipIf(isEdge)('action() performs variant document operations', async () => {
